...
if [ $# -eq 1 ]; then
  ...
  export LR_SYNTH_OUT_DIR_PREFIX="syn_out/nox"
...
export LR_SYNTH_CELL_LIBRARY_PATH=/test/synth/pdk_45nm/flow/platforms/nangate45/lib/NangateOpenCellLibrary_typical.lib
