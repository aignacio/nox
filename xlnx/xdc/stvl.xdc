# System clocks
# 200 MHz
set_property -dict {LOC AB11 IOSTANDARD LVDS} [get_ports clk_in_p]
set_property -dict {LOC AC11 IOSTANDARD LVDS} [get_ports clk_in_n]
create_clock -period 5.000 -name clk_200mhz [get_ports clk_in_p]
...
set_property -dict {PACKAGE_PIN V11  IOSTANDARD LVCMOS15} [get_ports {csr_out[6]}]
set_property -dict {PACKAGE_PIN Y12  IOSTANDARD LVCMOS15} [get_ports {csr_out[7]}]

set_false_path -to [get_ports {csr_out[*]}]
set_output_delay 0 [get_ports {csr_out[*]}]

# Reset button
set_property -dict {PACKAGE_PIN C24  IOSTANDARD LVCMOS33 } [get_ports rst_cpu]
...
# UART
set_property -dict {LOC M25 IOSTANDARD LVCMOS25 SLEW SLOW DRIVE 12} [get_ports uart_tx_o]
set_property -dict {LOC L25 IOSTANDARD LVCMOS25} [get_ports uart_rx_i]
